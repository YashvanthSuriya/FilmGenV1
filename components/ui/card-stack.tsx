  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute inset-0 flex items-end justify-center overflow-hidden px-12"
          style={{
        ...
        {showArrows && len > 1 ? (
          <div className="pointer-events-none absolute inset-x-2 top-1/2 z-[140] flex -translate-y-1/2 justify-between">
            <button
              ...
              onClick={prev}
              disabled={!canGoPrev}
              className="pointer-events-auto grid h-10 w-10 place-items-center rounded-full border border-white/15 bg-black/55 text-white shadow-lg backdrop-blur transition hover:border-accent-cyan hover:text-accent-cyan disabled:cursor-not-allowed disabled:opacity-35"
