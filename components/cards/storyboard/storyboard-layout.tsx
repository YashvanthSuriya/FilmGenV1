...
export function StoryboardWorkspaceLayout({
  ...
  return (
    <main className="relative min-h-[calc(100vh-var(--nav-height))] overflow-hidden bg-[#030506] text-text-primary">
      ...
      <div className="pointer-events-none absolute inset-0 opacity-[0.18] bg-[linear-gradient(90deg,rgba(255,255,255,0.08)_1px,transparent_1px),linear-gradient(0deg,rgba(255,255,255,0.06)_1px,transparent_1px)] bg-size-[72px_72px]" />
      {hero || composer ? (
