...
import { createObjectUrlForBlobKey } from "@/lib/storage/indexedDb"
...
export function FreeCutFrame() {
  ...
  const sendAssets = useCallback(async (targetAssets: ProjectAsset[]) => {
    ...
    iframe.contentWindow.postMessage({ type: "STUDIO_ASSETS", assets: resolved }, ALLOWED_ORIGIN)
  }, [])
